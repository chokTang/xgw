...
public class ResourcesUtil {
    ...
    public static Bitmap getBitmap(int resId, float scale) {
        ...
        try {
            ...
            Log.d(TAG, "Alert! OutOfMemoryError occured!");
            return null;
        }
    }
    ...
    public static int getStatusBarHeight() {
        int resourceId = sResouces.getIdentifier("status_bar_height", "dimen", "android");
        int height = sResouces.getDimensionPixelSize(resourceId);
        return height;
    }
}